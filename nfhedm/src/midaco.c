                ...
                double *param, long int P, char *key)
{
  ...
  {     
    ...
    *istop = 0;
    ...
    if(printeval >= 1)
    {
        //print_head(n,ni,m,me,&*param,maxeval,maxtime,printeval,save2file,&*key,&*iout);
  ...
  if((c == 3)&&(printeval > 0))
  {
 //print_final(*iflag,tnow,tmax,eval,maxeval,n,m,me,&*x,&*g,&*f,&*xl,&*xu,&*rw,acc,wres,param,&*iout); 
 if(save2file > 0)
 {
