...
#define SWIG_init    Tclfop_Init
#define SWIG_name    "tclfop"
#define SWIG_prefix  ""
...
#endif
SWIGINTERN int
_wrap_placebo_1(ClientData clientData SWIGUNUSED, Tcl_Interp *interp, int objc, Tcl_Obj *CONST objv[]) {
  double arg1 ;
  double arg2 ;
  double val1 ;
  int ecode1 = 0 ;
  ...
  if (SWIG_GetArgs(interp, objc, objv,"oo:placebo_1 x y ",(void *)0,(void *)0) == TCL_ERROR) SWIG_fail;
  ecode1 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[1], &val1);
  if (!SWIG_IsOK(ecode1)) {
    SWIG_exception_fail(SWIG_ArgError(ecode1), "in method '" "placebo_1" "', argument " "1"" of type '" "double""'");
  } 
  arg1 = (double)(val1);
  ecode2 = SWIG_AsVal_double SWIG_TCL_CALL_ARGS_2(objv[2], &val2);
  if (!SWIG_IsOK(ecode2)) {
    SWIG_exception_fail(SWIG_ArgError(ecode2), "in method '" "placebo_1" "', argument " "2"" of type '" "double""'");
  } 
  arg2 = (double)(val2);
  result = (double)placebo_1(arg1,arg2);
...
static swig_command_info swig_commands[] = {
    { SWIG_prefix "placebo_1", (swig_wrapper_func) _wrap_placebo_1, NULL},
    {0, 0, 0}
};
...
SWIGEXPORT int Tclfop_SafeInit(Tcl_Interp *interp) {
